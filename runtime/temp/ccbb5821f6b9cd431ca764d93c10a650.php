<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"F:\HTML\mzwz\public/../application/index\view\index\new_form.html";i:1486281001;}*/ ?>
<html>
<head>
<meta charset="utf-8">
...
<body style="background: #CAE1FF；">
<div style="background: #ccc;height:50px;">
<p style="font-size: 1.7em;padding: 1%;">少数民族学生信息创建个人信息档案</p>
<a href="home.html" style="float: right;margin: -3.8% 2%;font-size: 1.3em;">返回首页</a>
</div>
...
<button type="button" class="btn btn-primary btn-lg " style="margin:20px 150px;">提交</button>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"F:\HTML\bs\public/../application/index\view\edu\grade.html";i:1509687284;}*/ ?>
...
<div style="margin-top:5px">
    ...
    <tr>
        <th>获得总学分:</th>
        <td><?php echo $count_CRS; ?></td>
        <th>未通过科目数:</th>
        <td><?php echo $count_not_pass; ?></td>
    </tr>
    </table>
</div>
</div>

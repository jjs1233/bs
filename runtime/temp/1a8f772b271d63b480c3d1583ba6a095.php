<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\HTML\bs\public/../application/index\view\info\honest.html";i:1509687313;}*/ ?>
...
<div class="cztable">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align: center;">
        <tr>
            <td colspan="5">是否虚报贫困</td>
            <td><?php echo $pro['question_1']; ?></td>
        </tr>
        <tr>
            <td colspan="5">是否考试作弊</td>
            <td><?php echo $pro['question_2']; ?></td>
        </tr>
        <tr>
            <td colspan="5">贷款还贷情况</td>
            <td><?php echo $pro['question_3']; ?></td>
        </tr>
        <tr>
            <td colspan="5">学费缴纳情况</td>
            <td><?php echo $pro['question_4']; ?></td>
        </tr>
        <tr>
            <td colspan="5">是否履行实习及就业合同</td>
            <td><?php echo $pro['question_5']; ?></td>
        </tr>
        <tr>
            <td colspan="5">是否履行实习及就业合同</td>
            <td><?php echo $pro['question_6']; ?></td>
        </tr>
    </table>
</div>

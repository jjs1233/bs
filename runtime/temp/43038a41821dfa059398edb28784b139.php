<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\HTML\lgyc\public/../application/index\view\index\student_edit.html";i:1488367008;}*/ ?>
<html>
...
<body>
    ...
    <tr>
        <td>舍友</td>
        <td colspan="2"><input type="text" name="head_teacher" value="<?php echo $pro['dorm_friend']; ?>"></td>
        <td>手机</td>
        <td colspan="3"><input type="text" name="head_teacher_phone" value="<?php echo $pro['dorm_friend_phone']; ?>"></td>
    </tr>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <p>Copyright ©2017 <a href="INDEX/login">少数民族学生信息系统</a> All rights reserved.</p>
        </div>
    </footer>
</body>
